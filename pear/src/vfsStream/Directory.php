 ...
 * @api
 */
class vfsStream_Directory extends vfsStream_Abstract_Content implements vfsStream_Interface_Container
{
    /**
    ...
    public function __construct($name, $permissions = null)
    {
        if (strstr($name, '/') !== false) {
            throw new vfsStream_Exception('Directory name can not contain /.');
        }

        $this->type = vfsStream_Interface_Content::TYPE_DIR;
    ...
    public function sizeSummarized()
    {
        ...
        foreach ($this->children as $child) {
            if ($child->getType() === vfsStream_Interface_Content::TYPE_DIR) {
    ...
    {
        return new vfsStream_ContainerIterator($this->children);
    }
