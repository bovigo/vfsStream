...
/**
 * Test for orgbovigovfsvfsStreamContainerIterator.
 */
class vfsStreamContainerIteratorTestCase extends PHPUnit_Framework_TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->mockChild1 = $this->getMock('vfsStream_Interface_Content');
        $this->mockChild1->expects($this->any())
                         ->method('getName')
                         ->will($this->returnValue('bar'));
        $this->dir->addChild($this->mockChild1);
        $this->mockChild2 = $this->getMock('vfsStream_Interface_Content');
