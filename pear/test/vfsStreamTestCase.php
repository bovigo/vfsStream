...
class vfsStreamTestCase extends PHPUnit_Framework_TestCase
{
    ...
    public function newFile()
    {
        ...
        $this->assertInstanceOf('vfsStream_File', $file);
    ...
    public function setupRegistersStreamWrapperAndCreatesRootDirectoryWithDefaultNameAndPermissions()
    {
        ...
        $this->assertSame($root, vfsStream_Wrapper::getRoot());
    ...
    public function setupWorksRecursively()
    {
        ...
        $this->assertInstanceOf('vfsStream_Directory', $test);
        ...
        $this->assertInstanceOf('vfsStream_Directory', $foo);
    ...
    */
    ...
    {
        $baseDir = vfsStream::create(array('test' => array()), new vfsStream_Directory('baseDir'));
    ...
    public function createWorksRecursively()
    {
        $baseDir = vfsStream::create(array('test' => array('foo'     => array('test.txt' => 'hello'),
                                     ...
                                     new vfsStream_Directory('baseDir')
                   );
        $this->assertTrue($baseDir->hasChildren());
        $this->assertTrue($baseDir->hasChild('test'));
    ...
    {
        $baseDir = vfsStream::create(array('test.txt' => 'some content'), new vfsStream_Directory('baseDir'));
        $this->assertTrue($baseDir->hasChildren());
    ...
    */
    ...
    {
        $baseDir = vfsStream::create(array(2011 => array ('test.txt' => 'some content')), new vfsStream_Directory('baseDir'));
    ...
    */
    ...
    /**
     * helper function for assertions on vfsStream_File
     *
     * @param  vfsStream_File  $file
     * @param  string          $content
     */
    protected function assertVfsFile(vfsStream_File $file, $content)
    {
        $this->assertInstanceOf('vfsStream_File',
                                $file
        );
    ...
    public function inspectWithContentGivesContentToVisitor()
    {
        ...
        $mockVisitor = $this->getMock('vfsStream_Interface_Visitor');
    ...
    public function copyFromPreservesFilePermissions()
    {
        ...
        $this->assertEquals(fileperms($copyDir . '/withSubfolders') - vfsStream_Interface_Content::TYPE_DIR,
                            $root->getChild('withSubfolders')
                                 ->getPermissions()
        );
        $this->assertEquals(fileperms($copyDir . '/withSubfolders/aFile.txt') - vfsStream_Interface_Content::TYPE_FILE,
