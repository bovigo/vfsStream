...
/**
 * Test for orgbovigovfsvfsStream_Directory.
 */
class vfsStream_DirectoryTestCase extends PHPUnit_Framework_TestCase
{
    /**
     * instance to test
     *
     * @var  vfsStream_Directory
     */
    protected $dir;
    ...
    {
        $this->dir = new vfsStream_Directory('foo');
    }
    ...
    {
        $dir = new vfsStream_Directory('foo/bar');
    }
    ...
    {
        $this->assertEquals(vfsStream_Interface_Content::TYPE_DIR, $this->dir->getType());
    ...
    {
        $mockChild = $this->getMock('vfsStream_Interface_Content');
    ...
    public function childHandling()
    {
        ...
        $mockChild->expects($this->any())
                  ->method('getType')
                  ->will($this->returnValue(vfsStream_Interface_Content::TYPE_FILE));
        $mockChild->expects($this->any())
                  ->method('getName')
    ...
    public function childHandlingWithSubdirectory()
    {
        ...
        $mockChild->expects($this->once())
                  ->method('size')
                  ->will($this->returnValue(5));
        $subdir = new vfsStream_Directory('subdir');
    ...
    {
        $mockChild1 = $this->getMock('vfsStream_Interface_Content');
        ...
        $mockChild1->expects($this->any())
                   ->method('getName')
                   ->will($this->returnValue('bar'));
        $mockChild2 = $this->getMock('vfsStream_Interface_Content');
    ...
    public function explicitTestForSeparatorWithNestedPaths_Bug_24()
    {
        ...
        $subdir1 = new vfsStream_Directory('subdir1');
        $this->dir->addChild($subdir1);

        $subdir2 = new vfsStream_Directory('subdir2');
    ...
    {
        $this->dir = new vfsStream_Directory('foo', 0755);
        $this->assertEquals(0755, $this->dir->getPermissions());
