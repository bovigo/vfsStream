...
class vfsStreamWrapperFileTestCase extends vfsStreamWrapperBaseTestCase
{
    ...
    public function file_get_contentsNonReadableFile()
    {
        ...
        vfsStream::newFile('new.txt', 0000)->at(vfsStream_Wrapper::getRoot())->withContent('content');
    ...
    public function file_put_contentsExistingFileNonWritableDirectory()
    {
        ...
        vfsStream::newFile('new.txt')->at(vfsStream_Wrapper::getRoot())->withContent('content');
    ...
    public function file_put_contentsExistingNonWritableFile()
    {
        vfsStream_Wrapper::register();
        vfsStream_Wrapper::setRoot(new vfsStream_Directory('root'));
        vfsStream::newFile('new.txt', 0400)->at(vfsStream_Wrapper::getRoot())->withContent('content');
    ...
    public function canNotRemoveFileFromDirectoryWithoutWritePermissions()
    {
        vfsStream_Wrapper::register();
        vfsStream_Wrapper::setRoot(new vfsStream_Directory('root', 0000));
        vfsStream::newFile('new.txt')->at(vfsStream_Wrapper::getRoot());
