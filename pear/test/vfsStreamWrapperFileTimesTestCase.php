...
/**
 * Test for orgbovigovfsvfsStream_Wrapper.
 *
 * @since  0.9.0
 */
class vfsStream_WrapperFileTimesTestCase extends PHPUnit_Framework_TestCase
{
    /**
     * URL of foo.txt file
     *
     ...
     * @param  vfsStream_Interface_Content  $content  content to compare
     */
    protected function assertFileTimesEqualStreamTimes($url, vfsStream_Interface_Content $content)
    {
    ...
    public function createNewFileSetsAllTimesToCurrentTime()
    {
        ...
        $this->assertFileTimesEqualStreamTimes($this->fooUrl, vfsStream_Wrapper::getRoot()->getChild('foo.txt'));
    }
